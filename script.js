...
(function NX2_History(){
  ...
  // Coleta dos dados após seus cálculos
  ...
  window.addEventListener("DOMContentLoaded", ()=>{
    const bR = qs("#btnCalcUnico"); if(bR) bR.addEventListener("click", ()=> setTimeout(capturaRapido, 0));
    const bF = qs("#btnGerarFardos"); if(bF) bF.addEventListener("click", ()=> setTimeout(capturaFardos, 0));
    bind(); render();
  });
